...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementBanneryogaTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'ORDER' => ['ID' => 'DESC'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescyogaTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'FILTER' => ['ACTIVE' => 'Y'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescyoga2Table,
        'CACHE' => false
    ],
    false,
    []
