...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementBannerlijiTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'ORDER' => ['ID' => 'DESC'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescskiingTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'FILTER' => ['ACTIVE' => 'Y'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescskiing2Table,
        'CACHE' => false
    ],
    false,
    []
