...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementBannerbilliardTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'ORDER' => ['ID' => 'DESC'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescbilliardTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'FILTER' => ['ACTIVE' => 'Y'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescbilliard2Table,
        'CACHE' => false
    ],
    false,
    []
