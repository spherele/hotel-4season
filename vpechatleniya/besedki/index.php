...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementBannerbesedkiTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'ORDER' => ['ID' => 'DESC'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescbesedkiTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'FILTER' => ['ACTIVE' => 'Y'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescbesedki2Table,
        'CACHE' => false
    ],
    false,
    []
