...
?>
<style>
    @import url('https://fonts.googleapis.com/css2?family=Tenor+Sans&family=Wix+Madefor+Text&display=swap');
</style>
    <!-- Slider -->
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'FILTER' => ['ACTIVE' => 'Y'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementAboutTable,
        'CACHE' => false
    ],
    false,
    []
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'FILTER' => ['ACTIVE' => 'Y'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementAbout2Table,
        'CACHE' => false
    ],
    false,
    []
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'ORDER' => ['ID' => 'DESC'],
        'LIMIT' => 4,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementHotelFacilitiesTable,
        'CACHE' => true
    ],
    false
);
?>
    ...
    <section class="rooms1 section-padding" data-scroll-index="1">
        <div class="container">
            ...
            ?>
            <div class="row">
                <div class="butn-dark text-center" style="margin-top: 2%; margin-left: 1%">
                ...
                <div class="col-md-4 mb-30 offset-md-2"
                    ...
                    <? $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            'TITLE2' => 'Оставьте заявку, а наши заботливые менеджеры ответят на ваши вопросы и расскажут про
    спецпредложения',
                            'BUTTON' => 'Отправить',
