...
?>
    ...
    $APPLICATION->IncludeComponent(
        ...
        [
            ...
            'FILTER' => ['ACTIVE' => 'Y'],
            'LIMIT' => 1,
            'OBJECT' => new \Bitrix\Iblock\Elements\ElementBannersvadbaTable,
            'CACHE' => true
        ],
        false
    );
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'ORDER' => ['ID' => 'DESC'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescsvadbaTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'FILTER' => ['ACTIVE' => 'Y'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescsvadba2Table,
        'CACHE' => false
    ],
    false,
    []
