...
?>
    ...
    $APPLICATION->IncludeComponent(
        ...
        [
            ...
            'FILTER' => ['ACTIVE' => 'Y'],
            'LIMIT' => 1,
            'OBJECT' => new \Bitrix\Iblock\Elements\ElementBannerkidsTable,
            'CACHE' => true
        ],
        false
    );
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'ORDER' => ['ID' => 'DESC'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDesckidsTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'FILTER' => ['ACTIVE' => 'Y'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDesckids2Table,
        'CACHE' => false
    ],
    false,
    []
