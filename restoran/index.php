...
?>
    ...
    $APPLICATION->IncludeComponent(
        ...
        [
            ...
            'LIMIT' => 1,
            'OBJECT' => new \Bitrix\Iblock\Elements\ElementBannerrestoranTable,
            'CACHE' => true
        ],
        false
    );
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'ORDER' => ['ID' => 'DESC'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescrestoranTable,
        'CACHE' => true
    ],
    false
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'FILTER' => ['ACTIVE' => 'Y'],
        'LIMIT' => 1,
        'OBJECT' => new \Bitrix\Iblock\Elements\ElementDescrestoran2Table,
        'CACHE' => false
    ],
    false,
    []
                ...
                <div class="col-md-4 mb-30 offset-md-2"
                    ...
                    <? $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            'TITLE2' => 'Оставьте заявку, наши заботливые менеджеры ответят на ваши вопросы и расскажут про спецпредложения',
                            'BUTTON' => 'Отправить',
